package me.blueslime.scaredclans.storage.internal;
...
public class PluginStorage<K, V> {
    ...
    public static <K, V> PluginStorage<K, V> cloneHash(PluginStorage<K, V> original) {
    ...
    public static <K, V> PluginStorage<K, V> cloneConcurrentHash(PluginStorage<K, V> original) {
        return new PluginStorage<>(
